...
parser.add_argument('--dataset', type=str, default='diag', help='name of corpus')
parser.add_argument('--data_path', type=str, default='scripts/diag_dim60', help='directory containing data')
parser.add_argument('--emb_path', type=str, default='diag_60_emb.txt', help='directory containing word embeddings')
parser.add_argument('--save_path', type=str, default='./results/qq', help='path to save results')
parser.add_argument('--batch_size', type=int, default=1000, help='input batch size for training')

### model-related arguments
parser.add_argument('--num_topics', type=int, default=50, help='number of topics')
parser.add_argument('--rho_size', type=int, default=60, help='dimension of rho')
parser.add_argument('--emb_size', type=int, default=60, help='dimension of embeddings')
...
if args.mode == 'eval':
    ...
    ckpt = os.path.join(args.save_path, 
        'Dec19_etm_{}_K_{}_Htheta_{}_Optim_{}_Clip_{}_ThetaAct_{}_Lr_{}_Bsz_{}_RhoSize_{}_trainEmbeddings_{}'.format(
